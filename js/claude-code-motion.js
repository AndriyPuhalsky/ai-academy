...
/* ============================================================
   ЧАСТИНА Б переїхала у `js/ui.js` — 2026-09-04.

   Причина: поведінка компонента «термінал» (кнопка «копіювати» і
   розгортання довгого виводу) потрібна не лише лендінгу, а всім
   23 сторінкам модулів. Цей файл тягне GSAP, і підключати його
   на 23 уроки заради двох слухачів кліку було б дорого.
   `js/ui.js` уже підключений і тут (claude-code.html:348), і на
   кожній сторінці модуля — тому слухач живе там і працює всюди.

   Шукати: js/ui.js, блок «ПОВЕДІНКА КОМПОНЕНТА ТЕРМІНАЛ».
   ============================================================ */
