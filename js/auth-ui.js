...
(function () {
  ...
  /* ⚠ 010 · width/height ОБОВʼЯЗКОВІ. Розмір гліфа раніше задавав
     `.aia-close svg { width: var(--icon-sm) }` зі старої мови; у системі
  ...
  function wireModal(el) {
    ...
    function startWaiting(silent) {
      ...
      /* Ефект 10: решта діалогу гасне, кнопка Google лишається яскравою.
         Клас .aia-card.is-busy .aia-dim жив у старій мові; у системі 009
  ...
  function swapSlot(slot, html, after) {
    ...
    if (sk && ms) {
      /* 010 · клас .is-leaving жив у старій мові під СТАРИМ іменем `.sk`,
