/* ============================================================================
   ...
   ========================================================================== */
/* ⚠ 010 · КОЛО 2 · D-22. Заглушка на випадок, коли cdn.tailwindcss.com не
   відповів: без неї цей файл кидав необроблений `ReferenceError: tailwind is
   not defined` на всіх 66 сторінках. Вигляд при цьому не ламається — тему
   тримають tokens.css і components.css (QA перевірив: фон, Prata, розпирання
   0), тож єдиним наслідком був виняток у консолі.
   У нормальному порядку (цей файл підключений ПІСЛЯ CDN) window.tailwind уже
   існує, і `|| {}` не спрацьовує — тобто робочий шлях не змінюється. */
