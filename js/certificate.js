...
(function () {
  ...
  /* ---------- ПАЛІТРА АРКУША PDF ----------
     ...
     ⚠ Розсинхрон #BD5F40 (тут) проти #C4674A (css/custom.css) закривається
     САМИМ ЕТАПОМ 9: custom.css видаляється, і другої копії теракоти в
     проєкті не лишається взагалі. Значення тут — те, що реально друкувалось;
