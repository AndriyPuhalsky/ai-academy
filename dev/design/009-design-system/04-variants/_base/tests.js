...
(function (global) {
  ...
  function T5() {
    ...
    Array.prototype.forEach.call(document.styleSheets, function (sheet) {
      ...
      /* ⚠ ФІКС АГЕНТА №4. Спека, критерій 1: «єдиний файл зі значеннями —
         tokens.css (+ variant-*.css)». Без variant.css у цьому регексі T5
         оголошував би FAIL на кожному варіанті лише за те, що варіант робить
         рівно те, для чого існує — перевизначає L1. */
      var isTokens = /tokens\.css|variant\.css/.test(name);
      var rules;
