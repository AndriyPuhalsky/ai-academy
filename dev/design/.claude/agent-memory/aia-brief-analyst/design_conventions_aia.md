...
- ⚠ **Застаріло, виправлено задачею 004 (звірено в коді 2026-09-07):** `faint` тепер
  **#9A9184** (5.80 на surface, AA проходить), а `#7A7164` лишився в `css/` тільки у двох
  коментарях. Історичний запис нижче лишаю, бо він пояснює, звідки взялась заборона.
