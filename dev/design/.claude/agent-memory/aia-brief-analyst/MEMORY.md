...
- [Design pipeline runs in stages](project_aia_design_pipeline.md) — owner gates between agents; 003 stopped after references; he wants the reference deliverable as an HTML page
- [How Andriy decides](user_andriy_decision_style.md) — picks direction by looking at options, not describing taste; answers "all of the above" to goal lists
