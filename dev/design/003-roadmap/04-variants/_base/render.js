...
(function () {
  ...
  // Корінь сайту — з атрибута: макет живе глибше в дереві, ніж житиме
  // справжній roadmap.html. У коді сайту це буде просто "".
  ...
  function load() {
    ...
    // Шлях до даних — з атрибута, бо варіанти лежать у сусідніх папках.
