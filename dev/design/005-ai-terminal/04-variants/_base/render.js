...
(function () {
  ...
  /* Шлях до конфіга можна перевизначити перед підключенням цього файла
     (window.CC_CONFIG_URL). Потрібно рівно для того, щоб три варіанти
     04-variants ділили ОДИН конфіг і один набір CSS, а не копіювали їх. */
  var CONFIG_URL = window.CC_CONFIG_URL || "claude-code.config.json";
