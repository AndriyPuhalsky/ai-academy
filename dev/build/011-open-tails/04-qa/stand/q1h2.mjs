...
const out = {};
for (const [pg, tag] of [["modules/architect-08", "architect"]]) {
  ...
  const r = await P.eval(`(function(){
    var el=[].filter.call(document.querySelectorAll('.ds-tbl__wrap, .term > .term__body, .ds-code > .ds-code__pre'), function(e){return e.scrollWidth-e.clientWidth>1 ;})[0];
