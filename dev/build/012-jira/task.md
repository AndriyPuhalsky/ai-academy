...
- **Статус:** **в роботі — контент: j01–j14 написані й відрецензовані, хвости закриті (2026-09-18); хвиля 4 (j15–j18) — автори готові (2026-09-18, ніч), рецензія триває.** (Каркас до дизайну готовий з 2026-09-17.)
  ...
  **Хвиля 4 (2026-09-18, ніч; слово власника «запускай четверту хвилю»): автори ×4 на j15–j18 — усі 4 готові** (коміти `295177c` j15 ·
  ...
  `facts-free-plan.md` «Дописано після хвилі 4». **Рецензенти ×4 на j15–j18 запущені ~00:10 2026-09-19.**
  **Далі:** після рецензії — документи й підготовка наступної сесії; хвиля 5 (j19–j23 + іспит) — **за словом власника**; чеклист — `dev/build/JOURNAL.md`
- **Заведено:** 2026-09-17
