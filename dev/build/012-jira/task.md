...
- **Статус:** чекає на дизайн — бриф `../../design/012-jira/task.md` заведено 2026-09-17;
  **код не чіпати до статусу `дизайн готовий`** в індексі `dev/design/README.md`
- **Заведено:** 2026-09-17
...
- **Програма, сюжет, факти про Jira Free, глосарій:** `dev/jira-course-plan.local.md`
  (локальний файл поза гітом — читати; при старті реалізації скопіювати програму в
