...
- **Статус:** **в роботі — контент: j01–j22 + іспит j23 написані й відрецензовані; хвиля 6 (іспит j23 + хвости попередніх хвиль + реєстр `open-claims.md`) закрита 2026-09-20. Далі — три довідники, за словом власника. Фірма сюжету з 2026-09-19 — «Марципан» (рішення власника; була «Кориця»).** (Каркас до дизайну готовий з 2026-09-17.)
