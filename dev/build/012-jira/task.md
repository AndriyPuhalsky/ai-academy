...
- **Статус:** **в роботі — програма й контент-каркас до дизайну** (з 2026-09-17, вечір).
  ...
  **Хвиля 1 пройшла повністю 2026-09-17 (автори ×3 → рецензент ×3):** `modules/jira-01…03.html` фінальні
  ...
  ⚠ №3 фактів закрито. **Далі:** власник передає бриф дизайн-сесії сам; паралельно хвиля 2 авторів j04–j08
  (з апрувом) за `01-authoring/prompt-author.md` → рецензент за `prompt-reviewer.md`; чеклист —
  `dev/build/JOURNAL.md` «Старт наступної сесії»
- **Заведено:** 2026-09-17
