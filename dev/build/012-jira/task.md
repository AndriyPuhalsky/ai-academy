...
- **Статус:** **в роботі — програма й контент-каркас до дизайну** (з 2026-09-17, вечір).
  ...
  **Хвиля 1 пройшла повністю 2026-09-17 (автори ×3 → рецензент ×3):** `modules/jira-01…03.html` фінальні
  ...
  (коміти `d77f0e5`…`71cd305`), знахідки → `cross-findings.md` «Від рецензентів хвилі 2». **Далі:** автори
  j11–j14 (j11 частково написаний) — за словом власника; чеклист — `dev/build/JOURNAL.md`
- **Заведено:** 2026-09-17
