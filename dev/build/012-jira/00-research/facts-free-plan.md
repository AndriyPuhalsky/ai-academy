...
| 3 | JSM Free | **3 агенти**, клієнти — без ліміту, 2 GB; є: workflows, **SLA**, автоматизація (**1 250 steps**, лише в межах спейсу), work-level security; немає: custom reports, multi-channel support, global/multi-space automation, virtual service agent, audit logs | ✅ | "Up to 3 agents" · "Unlimited" · "Customizable workflows and SLA's" · "Automation — 1,250 steps per subscription" | explore-jira-cloud-plans (розділ JSM) | j18, j19 |
| 3 | JSM база знань | потребує **додати Confluence на сайт** (купувати не треба) | ✅ | "No purchase of Confluence is required, but you must add Confluence to your site to unlock these features." | там само | j16, j19 |
