...
- [Застосування міграцій через Chrome](project_aia_migration_apply_via_chrome.md) — разовий дозвіл на названий файл; перевіряти довжину в Monaco ДО Run, звіряти символи, не байти
