...
- [Сертифікат: растр без посилань і 27 МБ](project_certificate_pdf_findings.md) — знайдено на першому виданому сертифікаті; перевіряти сам файл, а не шаблон; сертифікат неперевидаваний
