...
48. `/modules/module-07` на 390 px: `document.documentElement.scrollWidth === 390`,
    елементів із `right > innerWidth` — нуль.
...
60. Leaked password protection (К12): у звіті бекендера — стан «увімкнено» з датою; у
    `tg/CHANGELOG.md` є запис. QA **не** заходить у Dashboard і **не** пробує реєструватись
    зі слабким паролем — реєстрація пише в продову базу.
